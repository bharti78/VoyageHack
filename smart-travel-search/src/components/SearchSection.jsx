...
@media (max-width: 992px) {
  ...
  @media (max-width: 640px) {
    ...
    .products-dropdown { left: 50% !important; transform: translateX(-50%) !important; }
  }
`;
...
const PRODUCTS = [
  ...
  },
  {
    id: "carrental",
    name: "Car Rental",
    desc: "Self-drive at your pace",
    icon: "🚗",
    colorClass: "carrental",
  },
];
      ...
      <div className="cal-grid">
        ...
        {cells.map((d, i) => (
          <div
            ...
            onMouseEnter={() =>
              d && onHover && onHover(new Date(year, month, d))
            }
          >
            {d}
          </div>
...
function CircleSelector({ duration, onChange }) {
  ...
  const startX = CX + R * Math.cos(arcStart),
    startY = CY + R * Math.sin(arcStart);
  const endX = CX + R * Math.cos(arcEnd),
    endY = CY + R * Math.sin(arcEnd);
  ...
  function handleMove(e) {
    ...
    onChange(
      Math.max(
        min,
        Math.min(max, Math.round(((a + 150) / 300) * (max - min) + min)),
      ),
    );
  }
  return (
    ...
    >
      ...
      >
        ...
        <circle
          ...
          style={{
            cursor: "grab",
            filter: "drop-shadow(0 2px 6px rgba(255,80,50,0.5))",
          }}
          onMouseDown={() => {
  ...
  "Travel buyers": [
    {
      ...
      desc: "Benefit from round-the-clock customer support in your local language, ensuring seamless service and customer satisfaction, with over 500 account managers offering warm and dedicated assistance.",
    },
    {
      title: "Earn reward points",
      desc: "With TBO+, earn reward points from your very first booking and access free learning opportunities on travel products with TBO Academy.",
    },
    {
      title: "Leverage TBO to increase sales",
      desc: "With TBO+ reward program, you can increase bookings through exclusive promotions that will be marketed to travel agents.",
    },
  ],
  "Travel suppliers": [
    {
      title: "Global distribution network",
      desc: "Instantly connect with over 159,000 travel buyers across 100+ countries and grow your reach without additional marketing spend.",
    },
    {
      title: "Real-time inventory management",
      desc: "Manage live availability and pricing across all channels through our powerful, easy-to-use supplier portal.",
    },
    {
      title: "Revenue analytics",
      desc: "Access detailed reports on booking trends, top-performing buyers, and revenue opportunities to optimize your strategy.",
    },
  ],
  Travelpreneurs: [
    {
      title: "Zero investment startup",
      desc: "Launch your own travel business with no upfront cost — use TBO's platform, supplier network, and tools from day one.",
    },
    {
      title: "Training & mentorship",
      desc: "Get certified through TBO Academy and receive dedicated mentorship to accelerate your growth as a travel entrepreneur.",
    },
    {
      title: "Earn from day one",
      desc: "Start earning commissions immediately on bookings while building expertise and a loyal client base.",
    },
  ],
};
const stories = [
  {
    ...
    org: "Travel Agent",
    info: "orange-info",
    video: "https://www.tbo.com/img/testimonials/agent/Dinesh-Poojary.mp4",
  },
  {
    name: "Gautam Vij",
    org: "KBS Tours and Travels, India",
    info: "blue-info",
    video: "https://www.tbo.com/img/testimonials/agent/Gautam-Vij.mp4",
  },
  {
    name: "Sebastian Sierra",
    org: "Travel Agent",
    info: "green-info",
    video: "https://www.tbo.com/img/testimonials/agent/Sebastian-Sierra.mp4",
  },
  {
    name: "Stuart Lee",
    org: "Travel Agent",
    info: "tan-info",
    video: "https://www.tbo.com/img/testimonials/agent/Stuart-Lee.mp4",
  },
  {
    name: "UAE Agent",
    org: "UAE",
    info: "orange-info",
    video: "https://www.tbo.com/img/testimonials/agent/UAEAgenta.mp4",
  },
  {
    name: "Mr. Kuljit Singh Hayer",
    org: "Universal Travels, India",
    info: "green-info",
    video: "https://www.tbo.com/img/testimonials/agent/KuljitSingh.mp4",
  },
  {
    name: "Fortun Plumley",
    org: "Travel Agent",
    info: "blue-info",
    video: "https://www.tbo.com/img/testimonials/agent/Fortun-PlumLey.mp4",
  },
];
const awards = [
  {
    img: "https://www.tbo.com/img/awards/TWMGold_Award_2024.png",
    label: "TWM Gold Award 2024",
  },
  {
    img: "https://www.tbo.com/img/awards/BDD_B2B_campaign.png",
    label: "Best Data Driven B2B Campaign",
  },
  {
    img: "https://www.tbo.com/img/awards/BTDC_Y_2024.png",
    label: "Best Travel Distribution Company 2024",
  },
  {
    img: "https://www.tbo.com/img/awards/EoTYAward_2024.png",
    label: "Entrepreneur of the Year 2024",
  },
  {
    img: "https://www.tbo.com/img/awards/OTM_of_the_year.png",
    label: "OTM of the Year",
  },
  {
    img: "https://www.tbo.com/img/awards/MEB_B2B_Travel_Portal_2025.png",
    label: "Middle East's Best B2B Travel Portal 2025",
  },
  {
    img: "https://www.tbo.com/img/awards/LAB_B2B_Travel_Provider_2025.png",
    label: "Latin America's Best B2B Travel Provider 2025",
  },
...
const brandLogos = [
  ...
  {
    src: "https://www.tbo.com/img/brands/jumbonline-min.png",
    alt: "JumbOnline",
  },
  { src: "https://www.tbo.com/img/brands/paxes-min.png", alt: "PAXES" },
  { src: "https://www.tbo.com/img/brands/kizanlogo-min.png", alt: "Kizan" },
  {
    src: "https://www.tbo.com/img/brands/tboacademy-min.png",
    alt: "TBO Academy",
  },
  {
    src: "https://www.tbo.com/img/brands/classic-vacations.png",
    alt: "Classic Vacations",
  },
];
const footerLinks = [
  "Home",
...
function useSliderSizes() {
  ...
  useEffect(() => {
    function calc() {
      ...
      if (W < 480) {
        vc = 1;
        cw = Math.floor(W * 0.86);
        va = 2;
        aw = Math.floor((W * 0.86 - 22) / 2);
      } else if (W < 640) {
        vc = 2;
        cw = Math.floor((W * 0.86 - 18) / 2);
        va = 3;
        aw = Math.floor((W * 0.86 - 44) / 3);
      } else if (W < 1000) {
        vc = 3;
...
export default function TBOHomepage() {
  ...
  useEffect(() => {
    ...
    const t = setInterval(
      () => setSlideIdx((p) => (p >= maxSlide ? 0 : p + 1)),
      3000,
    );
  ...
  useEffect(() => {
    ...
    const t = setInterval(
      () => setAwardIdx((p) => (p >= maxAward ? 0 : p + 1)),
      2500,
    );
    return () => clearInterval(t);
  ...
  useEffect(() => {
    if (awardIdx > maxAward) setAwardIdx(maxAward);
  }, [maxAward]);
  ...
  const recents = filtered.filter((d) => d.recent),
    others = filtered.filter((d) => !d.recent);
  ...
  function whenValue() {
    ...
    if (whenTab === "Months")
      return `${formatDate(new Date())} – ${formatDate(addMonths(new Date(), monthsDuration))}`;
    if (whenTab === "Flexible" && stayType && selectedMonths.length > 0)
      return `${stayType} · ${selectedMonths.length} mo`;
    return null;
  }
  ...
  function whoValue() {
    ...
    if (guests.infants)
      s += `, ${guests.infants} infant${guests.infants !== 1 ? "s" : ""}`;
  ...
  function typeValue() {
    ...
    if (selectedTypes.length === 1)
      return TRAVEL_TYPES.find((t) => t.id === selectedTypes[0])?.label;
  ...
  const nextM = {
    y: calMonth.m === 11 ? calMonth.y + 1 : calMonth.y,
    m: (calMonth.m + 1) % 12,
  };
  ...
  function handleImageUpload(e) {
    ...
    if (f) console.log("Image for search:", f.name);
  }
      ...
      <div className="tbo-wrap">
        ...
        <div className="tbo-hero-section">
          ...
          <nav className={`tbo-nav${navScrolled ? " scrolled" : ""}`}>
            ...
            <div className="tbo-logo-wrap">
              <img
                src="https://www.tbo.com/img/LogoRamadan.gif"
                alt="tbo.com – Travel Simplified"
                className="tbo-logo-img"
              />
            </div>
            ...
            <div className="search-bar-container" ref={searchRef}>
              ...
              {searchExpanded ? (
                ...
                <div className={`search-pill ${openPanel ? "active" : ""}`}>
                  <div
                    className={`pill-section ${openPanel === "type" ? "open" : ""}`}
                    style={{ maxWidth: 120 }}
                    onClick={() =>
                  ...
                  >
                    ...
                    <span
                      className={`pill-value ${!typeValue() ? "placeholder" : ""}`}
                    >
                      {typeValue() || "Any type"}
                    </span>
                  </div>
                  ...
                  >
                    ...
                    <span
                      className={`pill-value ${!destination ? "placeholder" : ""}`}
                    >
                  ...
                  <div
                    ...
                    style={{ maxWidth: 145 }}
                    onClick={() =>
                      setOpenPanel(openPanel === "when" ? null : "when")
                    }
                    role="button"
                    aria-label="When"
                  >
                    ...
                    <span
                      className={`pill-value ${!whenValue() ? "placeholder" : ""}`}
                    >
                      {whenValue() || "Add dates"}
                    </span>
                  </div>
                  <div
                    ...
                    style={{ maxWidth: 135 }}
                    onClick={() =>
                      setOpenPanel(openPanel === "who" ? null : "who")
                    }
                    role="button"
                    aria-label="Who"
                  >
                    ...
                    <span
                      className={`pill-value ${!whoValue() ? "placeholder" : ""}`}
                    >
                      {whoValue() || "Guests"}
                    </span>
                  </div>
                  <div
                    className={`pill-section ${openPanel === "budget" ? "open" : ""}`}
                    style={{ maxWidth: 120 }}
                    onClick={() =>
                      setOpenPanel(openPanel === "budget" ? null : "budget")
                    }
                    role="button"
                    aria-label="Budget"
                  >
                    ...
                    <span
                      className={`pill-value ${!budgetValue() ? "placeholder" : ""}`}
                    >
                      {budgetValue() || "Any"}
                    </span>
                  </div>
                  <button
                    className="pill-redirect-btn"
                  ...
                  <button
                    className="pill-search-icon-btn"
                    onClick={() => {
                      setOpenPanel(null);
                  ...
                  {openPanel === "type" && (
                    <div
                      className="dropdown-panel type-dropdown"
                      style={{ left: 0 }}
                    >
                      ...
                      <div className="type-grid">
                        {TRAVEL_TYPES.map((t) => (
                          <div
                            key={t.id}
                            className={`type-card ${selectedTypes.includes(t.id) ? "active" : ""}`}
                  ...
                  {openPanel === "where" && (
                    <div
                      className="dropdown-panel where-dropdown"
                      style={{ left: "15%" }}
                    >
                      <input
                  ...
                  {openPanel === "when" && (
                    <div
                      className="dropdown-panel when-dropdown"
                    ...
                    >
                      <div className="when-tabs">
                        {["Dates", "Months", "Flexible"].map((t) => (
                          <button
                            key={t}
                            className={`when-tab ${whenTab === t ? "active" : ""}`}
                            onClick={() => setWhenTab(t)}
                          >
                            {t}
                          </button>
                        ))}
                          ...
                          <>
                            <div className="cal-container">
                              <Calendar
                                ...
                                onHover={!endDate ? setHoverDate : null}
                                showPrev
                                onPrev={() =>
                                  calMonth.m === 0
                                    ? setCalMonth({ y: calMonth.y - 1, m: 11 })
                                    : setCalMonth({
                                        y: calMonth.y,
                                        m: calMonth.m - 1,
                                      })
                              ...
                              <Calendar
                                ...
                                onNext={() =>
                                  calMonth.m === 11
                                    ? setCalMonth({ y: calMonth.y + 1, m: 0 })
                                    : setCalMonth({
                                        y: calMonth.y,
                                        m: calMonth.m + 1,
                                      })
                            ...
                            <div className="flex-options">
                              {[
                                ...
                                <button
                                  key={f}
                                  className={`flex-chip ${flexDays === f ? "active" : ""}`}
                                  onClick={() => setFlexDays(f)}
                                >
                                  {f}
                                </button>
                              ))}
                        ...
                        {whenTab === "Months" && (
                          <div className="months-tab-body">
                            <CircleSelector
                              ...
                              onChange={setMonthsDuration}
                            />
                            <div className="months-range-display">
                              <div className="months-range-text">
                                {formatDate(new Date())} –{" "}
                                {formatDate(
                                  addMonths(new Date(), monthsDuration),
                                )}
                              </div>
                              <div className="months-range-sub">
                                {monthsDuration} month
                                {monthsDuration !== 1 ? "s" : ""} trip
                              </div>
                              <div className="months-hint">
                                Drag the circle handle to adjust
                              </div>
                            </div>
                          </div>
                        )}
                          ...
                          <>
                            ...
                            <div className="flex-stay-options">
                              {[
                                ...
                                <button
                                  key={s.name}
                                  className={`flex-stay-btn ${stayType === s.name ? "active" : ""}`}
                                  onClick={() => setStayType(s.name)}
                                >
                            ...
                            <div className="month-cards-scroll">
                              {futureMonths.map((m, i) => {
                                ...
                                return (
                                  <div
                                    key={key}
                                    className={`month-card ${selectedMonths.includes(key) ? "active" : ""}`}
                  ...
                  {openPanel === "who" && (
                    <div
                      className="dropdown-panel who-dropdown"
                      style={{ right: "17%", left: "auto" }}
                    >
                  ...
                  {openPanel === "budget" && (
                    <div
                      className="dropdown-panel budget-dropdown"
                    ...
                    >
                      ...
                      <div className="budget-options">
                        {BUDGET_OPTIONS.map((b) => (
                          <div
                            key={b.id}
                            className={`budget-option ${selectedBudget === b.id ? "active" : ""}`}
                            onClick={() =>
                              setSelectedBudget(
                                selectedBudget === b.id ? null : b.id,
                              )
                            }
                          >
                            <span className="budget-option-icon">{b.icon}</span>
                            <div className="budget-option-info">
                              <div className="budget-option-label">
                                {b.label}
                              </div>
                              <div className="budget-option-range">
                                {b.range}
                              </div>
                            </div>
                            {selectedBudget === b.id && (
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          setBudgetSlider(+e.target.value);
                      ...
                      <div className="budget-range-values">
                        ...
                        <span style={{ color: "#ff6600", fontWeight: 600 }}>
                          ₹{Math.round(budgetSlider * 5000).toLocaleString()}
                        </span>
                        <span>₹5L+</span>
                      </div>
                      <div
            ...
            {/* ── PRODUCTS BUTTON — between search and nav-right ── */}
            <div className="products-nav-wrap" ref={productsRef}>
              <button
                className={`btn-products${productsOpen ? " open" : ""}`}
                ...
                >
                  {PRODUCTS.map((p) => (
                    <div
                      ...
                      role="button"
                    >
                      <div className={`product-item-icon ${p.colorClass}`}>
                        {p.icon}
                      </div>
          ...
          <div className="tbo-hero">
            <div>
              <h1 className="hero-title">
                Simplifying Travel<span className="red-dot">.</span>
                <br />
                Enabling Growth
              </h1>
              <p className="hero-body">
                We are one of the leading global travel distribution platforms,
                simplifying the travel business for both suppliers and buyers.
                Our suppliers include hotels, airlines, cruises, car rentals,
                transfers, and rail services. Our buyers consist of retail and
                API buyers such as travel agencies, independent travel advisors,
                and enterprise buyers including tour operators, travel
                management companies, online travel companies, super-apps, and
                loyalty apps.
              </p>
              <p className="hero-body" style={{ marginTop: 14 }}>
                Our platform enables seamless transactions, connecting over
                159,000 buyers with over 1 million suppliers across 100+
                countries.
              </p>
            ...
            <div className="hero-video-wrap">
              <video
                src="https://www.tbo.com/img/videos/The-World-of-TBO-Group.mp4?var=300420244"
                autoPlay
                muted
                loop
                playsInline
        ...
        <section className="tbo-numbers">
          ...
          <div className="stats-row">
            {[
              { num: "159K+", label: "Travel buyers" },
              { num: "1M+", label: "Hotels worldwide" },
              { num: "100+", label: "Countries" },
              { num: "55+", label: "Supported currencies" },
            ].map((s) => (
        ...
        <section className="tbo-value">
          ...
          <div className="value-tabs">
            {Object.keys(valueContent).map((tab) => (
              <button
                key={tab}
                className={`value-tab ${activeTab === tab ? "active" : ""}`}
          ...
          <div className="value-content-area">
            <img
              src="https://www.tbo.com/img/travelbuyers.webp"
              alt="Travel Buyers"
              className="value-blob-img"
            />
        ...
        <section className="tbo-partner-brands">
          ...
          <div className="partner-row">
            <div className="expedia-wrap">
              <div className="expedia-top">
                <span style={{ color: "#e05500" }}>⬡</span> expedia
              </div>
            ...
            >
              <span style={{ fontWeight: 300 }}>Derby</span>Soft
            </div>
            <div
              style={{
                display: "flex",
            ...
            <div
              style={{ fontSize: "clamp(1rem,1.6vw,1.2rem)", color: "#1c1c1c" }}
            >
              <span style={{ fontWeight: 300 }}>ibs</span>
        ...
        <section className="tbo-growth">
          ...
          >
            ...
            <div className="slider-viewport" style={{ width: svWidth }}>
              <div
                ...
                style={{
                  transform: `translateX(-${slideIdx * (cardW + GAP)}px)`,
                }}
              >
                {stories.map((s, i) => (
            ...
            <button
              className="slider-arrow"
              onClick={() => setSlideIdx(Math.min(maxSlide, slideIdx + 1))}
          ...
          <div className="growth-dots">
            {Array.from({ length: maxSlide + 1 }).map((_, i) => (
              <button
                key={i}
                className={`gdot ${slideIdx === i ? "active" : ""}`}
        ...
        <section className="tbo-awards">
          ...
          >
            ...
            <div className="awards-viewport" style={{ width: avWidth }}>
              <div
                ...
                style={{
                  transform: `translateX(-${awardIdx * (awardW + AWARD_GAP)}px)`,
                }}
              >
                {awards.map((a) => (
                  <div
            ...
            <button
              className="awards-arrow"
              onClick={() => setAwardIdx(Math.min(maxAward, awardIdx + 1))}
              disabled={awardIdx >= maxAward}
            >
              ›
            </button>
          </div>
          <div className="awards-dots">
            {Array.from({ length: maxAward + 1 }).map((_, i) => (
              <button
                key={i}
                className={`adot ${awardIdx === i ? "active" : ""}`}
