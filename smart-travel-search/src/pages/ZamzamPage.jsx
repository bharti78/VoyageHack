...
export default function ZamzamPage() {
  return (
    <SolutionStaticPage
      title="Zamzam & Kizan"
      lead="Zamzam.com is approved OTA [Online Travel Agency] by the Ministry of Hajj & Umrah (MoHU), Saudi Arabia. It is an online portal for completing the full process of Umrah booking including hotel bookings, transfers, meet and assist followed by ground handling to smoothen the spiritual journey.\n\nKizan, a registered Destination Management Company in Saudi Arabia, collaborates closely with the Saudi Tourism Authority, specializing in curated inbound and domestic tourism experiences that showcase the diverse offerings of Saudi Arabia."
