...
const css = `
  ...
  @media (max-width: 1100px) {
    ...
    .crp-frame { height: calc(100dvh - 72px - 92px); }
  }
  @media (max-width: 640px) {
    .crp-page-wrap { padding-top: 64px; }
    .crp-frame { height: calc(100dvh - 64px - 92px); min-height: 420px; }
  }
  @supports not (height: 100dvh) {
    .crp-page-wrap { min-height: 100vh; }
    .crp-frame { height: calc(100vh - 80px - 92px); }
    @media (max-width: 1100px) { .crp-frame { height: calc(100vh - 72px - 92px); } }
    @media (max-width: 640px) { .crp-frame { height: calc(100vh - 64px - 92px); } }
  }
`;
